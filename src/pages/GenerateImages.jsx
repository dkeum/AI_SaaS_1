    ...
    <div>
      <div className="h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700">
        ...
        >
          ...
          <p className="mt-5 text-sm font-medum">Describe your image</p>
          <textarea
          ...
          <br />
          <button className="w-full flex justify-center items-center gap-2 bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-lg curosr-pointer">
            <Image className="w-5" />
            Generate Image
          </button>
        </form>
