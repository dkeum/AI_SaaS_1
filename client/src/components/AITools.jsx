...
const AITools = () => {
  ...
  return (
    <div className="px-4 sm:px-20 xl:px-32 my-24">
      <div>
        <h2 className="text-slate text-[42px] font-semibold">
          Powerful AI Tools
        </h2>
      ...
      <div className="flex flex-wrap mt-10 justify-center">
        {AiToolsData.map((tool, index) => (
          ...
          >
            ...
            <h3 className="mt-6 mb-3 text-lg font-semibold text-left">{tool.title}</h3>
            <h3 className="text-gray-400 text-sm max-w-[95%] text-left">{tool.description}</h3>
          </div>
        ))}
      </div>
    </div>
